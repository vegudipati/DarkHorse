...
class OllamaAdapter {
    ...
    constructor(baseUrl, // e.g. 'http://127.0.0.1:11434'
    model, // e.g. 'codellama:34b'
    systemPromptOverride) {
    ...
    async callOllama(prompt) {
        ...
        try {
            ...
            throw new Error(`Cannot reach Ollama at ${this.baseUrl}. ` +
        ...
        if (!response.ok) {
            if (response.status === 404) {
                throw new Error(`Ollama model "${this.model}" not found. ` +
