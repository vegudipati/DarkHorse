...
export class AbapSystemPrompt {

  // ---------------------------------------------------------------------------
  // Generate system prompt
  // ---------------------------------------------------------------------------

  static readonly GENERATE = `You are DarkHorse, an expert SAP ABAP developer assistant integrated into the DarkHorse IDE.
...
- When generating a report, include REPORT statement at the top`;
  ...
  static readonly REVIEW = `You are DarkHorse, an expert SAP ABAP code reviewer integrated into the DarkHorse IDE.
...
If the code is clean, return an empty findings array and severity "clean".`;
  ...
  static readonly EXPLAIN = `You are DarkHorse, an expert SAP ABAP developer assistant integrated into the DarkHorse IDE.
...
- Keep the explanation concise — a developer should be able to read it in under 2 minutes`;
   ...
   */
  static get(operation: 'generate' | 'review' | 'explain' = 'generate'): string {
    switch (operation) {
